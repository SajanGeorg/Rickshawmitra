 ...
 */
public class RajuGarageFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public RajuGarageFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_raju_bro_garage_map ,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Raju Brothers Auto-Garage");
