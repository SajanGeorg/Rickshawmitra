 ...
 */
public class kamat_fragment_map extends Fragment implements OnMapReadyCallback {
    GoogleMap map;

    public kamat_fragment_map() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_rr_map, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("RR  Hospital & Research center");
