 ...
 */
public class PTGarageFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public PTGarageFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_p_t_garage_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("P&T Garage");
