 ...
 */
public class TrafficchowkFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public TrafficchowkFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_traffic_chowk_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Traffic Chowk");
