 ...
 */
public class SagarGarageFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public SagarGarageFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_sagar_mech_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Sagar Rickshaw Garage");
