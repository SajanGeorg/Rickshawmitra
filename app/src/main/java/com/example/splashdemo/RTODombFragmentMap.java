 ...
 */
public class RTODombFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public RTODombFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_rto_domb_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("RTO Dombivli");
