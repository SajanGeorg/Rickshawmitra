 ...
 */
public class HPPetrFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public HPPetrFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_hp_petr_map ,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("HP Petrol Pump");
