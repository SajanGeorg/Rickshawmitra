 ...
 */
public class MahanagarCNGFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public MahanagarCNGFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_bharat_cng_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Mahanagr CNG Pump");
