 ...
 */
public class TechnoPetFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public TechnoPetFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_techno_pet_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Techno CNG Pump");
