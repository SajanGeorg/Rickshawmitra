 ...
 */
public class ShaktiMechFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public ShaktiMechFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_shakti_mech_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Shakti Mechanic");
