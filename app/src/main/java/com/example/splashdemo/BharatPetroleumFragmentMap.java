 ...
 */
public class BharatPetroleumFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public BharatPetroleumFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_bharat_petroleum_map ,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Bharat Petroleum");
