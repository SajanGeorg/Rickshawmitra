 ...
 */
public class AimsFragmentMap extends Fragment implements OnMapReadyCallback {
    GoogleMap map;



    public AimsFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_aimshospital_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Aims Hopsital");
