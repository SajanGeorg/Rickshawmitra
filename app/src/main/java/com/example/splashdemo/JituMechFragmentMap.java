 ...
 */
public class JituMechFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public JituMechFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_jitu_mech_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Jitu Mechanic");
