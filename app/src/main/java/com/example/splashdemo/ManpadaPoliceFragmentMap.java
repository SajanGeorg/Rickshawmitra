 ...
 */
public class ManpadaPoliceFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public ManpadaPoliceFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_manpada_police_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Manpada Police Station");
