 ...
 */
public class AshokGarageFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public AshokGarageFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_ashok_garage_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Ashok Rickshaw Garage");
