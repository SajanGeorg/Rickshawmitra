 ...
 */
public class JituGarageFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public JituGarageFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_jitu_garage_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Jitu Auto-Garage");
