 ...
 */
public class ShaktiGarageFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public ShaktiGarageFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_shakti_garage_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Shakti Auto Parts & Garage");
