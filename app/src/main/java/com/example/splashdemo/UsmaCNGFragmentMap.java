 ...
 */
public class UsmaCNGFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public UsmaCNGFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_usma_cng_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Usma CNG Pump");
