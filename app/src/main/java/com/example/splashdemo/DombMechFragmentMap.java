 ...
 */
public class DombMechFragmentMap extends Fragment implements OnMapReadyCallback {
GoogleMap map;

    public DombMechFragmentMap() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_domb_mech_map,container,false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        option.position(pp).title("Dombivli Mechanic");
